...
export default function BudgetDetail() {
  ...
  useEffect(() => {
    Promise.all([getBudgetDetail(id), getProductList(), getClientsList()])
            ...
            <Grid container>
              <List>
                <ListItem>
                  ...
                  <ListItemText
                    primary={budget.client.RS}
                    secondary={budget.client.NIF}
                  />
                </ListItem>
                <ListItem>
                  <ListItemAvatar>
                  ...
                  <ListItemText
                    primary={budget.client.Address}
                    secondary={budget.client.City}
                  />
                </ListItem>
                <ListItem>
                  <ListItemAvatar>
                  ...
                  <ListItemText
                    primary={budget.client.Email}
                    secondary={budget.client.Phone}
                  />
                </ListItem>
              </List>
